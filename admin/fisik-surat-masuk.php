                ...
                <!-- <div class="container-fluid"> -->
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h4 mb-0 text-gray-800 border-bottom">‎‎Daftar Fisik Surat Masuk</h1>
                        <!-- ditambahin icon surat di kiri tulisannya -->
                        <div>
                        <a href="?page=fisik-surat-masuk" class="btn btn-sm btn-success">Surat Masuk </a>
                        <a href="?page=fisik-surat-keluar" class="btn btn-sm">Surat Keluar </a>
                        </div>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                          Daftar Fisik Arsip Surat Masuk
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php 
                                            $no = 1;
                                            $dt = mysqli_query($mysqli, "select * from smasuk");
