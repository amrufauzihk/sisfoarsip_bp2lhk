                ...
                <!-- <div class="container-fluid"> -->
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div>
                        <a href="?page=pinjam-arsip-masuk" class="btn btn-sm ">Surat Masuk </a>
                        <a href="?page=pinjam-arsip-keluar" class="btn btn-sm btn-success">Surat Keluar </a>
                        </div>
                    </div>
                                                  ...
                                                  <div class="modal fade" id="<?php echo "nostatus".$no ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                      <div class="modal-dialog" role="document">
                                                          <div class="modal-content">
                                                              ...
                                                              <div class="modal-body">Silahkan Konfirmasi Pada Kolol status peminjaman</div>
                                                  ...
                                                  <div class="form-group">
                                                    ...
                                                    <?php  
                                                            ...
                                                            <option value="<?php echo $skeluar['id_surat'] ?>"<?php if ($skeluar['id_surat'] == $data['no_surat']) {
                                                              echo "Selected";
                                                            }?>><?php echo $skeluar['nomor_surat'] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                  </div>
                                                  <div class="form-group">
                    ...
                    <div class="modal-body text-gray-900">
                      ...
                      <div class="form-group">
                        ...
                        <?php  
                                  $qry = mysqli_query($mysqli, "SELECT * FROM skeluar");
                                    while($skeluar = mysqli_fetch_array($qry)){ ?>
                                <option value="<?php echo $skeluar['id_surat'] ?>"><?php echo $skeluar['nomor_surat'] ?></option>
                            <?php } ?>
                        </select>
                      </div>
                      <div class="form-group">
