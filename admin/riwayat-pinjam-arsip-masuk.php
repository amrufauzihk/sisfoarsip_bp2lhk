                ...
                <!-- <div class="container-fluid"> -->
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div>
                        <a href="?page=riwayat-pinjam-arsip-masuk" class="btn btn-sm btn-success">Surat Masuk </a>
                        <a href="?page=riwayat-pinjam-arsip-keluar" class="btn btn-sm">Surat Keluar </a>
                        </div>
                    </div>
