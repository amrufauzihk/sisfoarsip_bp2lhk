                ...
                <!-- <div class="container-fluid"> -->
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h4 mb-0 text-gray-800 border-bottom">‎‎Daftar Kode Arsip</h1>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php 
                                            $no = 1;
                                            $dt = mysqli_query($mysqli, "SELECT * FROM kode_arsip");
                                        ...
                                        <div class="modal fade" id="<?php echo "editModal".$no;?>" tabindex="-1" role="dialog" aria-hidden="true">
                                          <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                              ...
                                              <form action="controller.php?page=kode-arsip&action=update" method="POST">
                                                <div class="modal-body text-gray-900">
                                                  <div class="form-group">
                                                    <label for="data1">Kode Arsip</label>
                                                    <input type="hidden" name="id" value="<?php echo $data['id_kode'];?>">
                                                    <input type="hidden" name="page" value="<?php echo $_GET['page'];?>">
                                                    <input type="text" class="form-control" id="data1" name="kode" value="<?php echo $data['kode_arsip'];?>">
                                                  </div>
                                                  <div class="form-group">
                                                    <label for="data2">Perihal</label>
                                                    <input type="text" class="form-control" id="data2" name="perihal" value="<?php echo $data['keterangan'];?>">
                                                  </div>
                                                </div>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
                                                        <a class="btn btn-danger" href="controller.php?page=kode-arsip&action=delete&id=<?php echo $data['id_kode'] ?>&page1=<?php echo $_GET['page']?>">Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal fade" id="addDataModal" tabindex="-1" role="dialog" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                  ...
                  <form action="controller.php?page=kode-arsip&action=insert" method="POST">
                    <div class="modal-body text-gray-900">
                      <div class="form-group">
                        <label for="data1">Kode Arsip</label>
                        <input type="hidden" name="page" value="<?php echo $_GET['page']; ?>">
                      ...
                      <div class="form-group">
                        <label for="data2">Perihal</label>
                        <input type="text" class="form-control" id="data2" name="perihal">
                      </div>
                    </div>
                    <div class="modal-footer border-top-0 d-flex justify-content-center">
                      <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
